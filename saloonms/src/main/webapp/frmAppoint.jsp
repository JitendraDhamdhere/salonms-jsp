		...
		<div class="container">
			<div class="row">
				<div class=" col-md-12 d-flex justify-content-center">
					<div class="title">
						<h2>
							Book Your<strong class="white"> Appointment for</strong> Services
						</h2>
					</div>
				</div>
			</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 ">
					...
					<form action="ppointdata.jsp" method="get" id="frmregi">
						<div class="row ">
							<%
							...
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<select class="form-control" style="height: 50px"
									onchange="loadcity(this.value)" name="txtser"
							...
							<!-- <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
								<Select class="form-control fun" style="height: 50px" id=result1
									name="txtprice" style="padding:;color:"
									onblur="validateEmpty(this,document.getElementById('mberr'),'price')">
