					...
					<div class="pricing_box">
						<div class="list">
							...
							<ul>
								...
								while (rs.next()) {
								%>
								<li><span class="float-left"><%=rs.getString(2)%></span><span
									class="float-right"><%=rs.getString(3)%></span></li>
								<%
								}
								%>
							</ul>
							...
							<ul>
								...
								while (rs1.next()) {
								%>
								<li><span class="float-left"><%=rs1.getString(2)%></span><span
									class="float-right"><%=rs1.getString(3)%></span></li>
								<%
								}
								%>
							</ul>
